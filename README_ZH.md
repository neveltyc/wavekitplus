...
<p align="center">
  ...
  <img alt="Tests" src="https://img.shields.io/badge/tests-46/46%20passed-22aa55?style=flat-square">
</p>
...
46 项测试覆盖 VCDParser、VcdReader、iverilog 生成 VCD、缓存层、xz_mask 及边界情况。无需 pytest。
