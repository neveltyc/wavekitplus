...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-0.9.5-3366cc?style=flat-square">
...
| Version | Highlight |
|:--------|:----------|
| `0.9.5` | root_scope signal matching, VCD subrange metadata, strict bit selection |
...
```powershell
.\release_tag.ps1 -Version v0.9.5 -CommitMessage "release: v0.9.5"
```
